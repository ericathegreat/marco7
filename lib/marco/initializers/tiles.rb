...
class Tiles < Initializer
	...
	register do |registry|
		...
		UI::AutoConnectTileSprite.new :water, offset_x_px: 64, offset_y_px: 16,
		 	o: Gosu::Image.new('img/water/o.png', tileable: true), 
		 	n: Gosu::Image.new('img/water/o.png', tileable: true), 
		 	en: Gosu::Image.new('img/water/o.png', tileable: true), 
		 	ns: Gosu::Image.new('img/water/o.png', tileable: true), 
		 	nw: Gosu::Image.new('img/water/o.png', tileable: true), 
		 	...
		 	es: Gosu::Image.new('img/water/o.png', tileable: true), 
		 	...
		 	sw: Gosu::Image.new('img/water/o.png', tileable: true), 
